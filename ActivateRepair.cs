...
public class ActivateRepair : MonoBehaviour
{
    ...
    void Update()
    {
		if (player.GetComponent<PlayerController> ().currentObjective == 3) {
			if (waitForPress && Input.GetKey (KeyCode.E) && player.GetComponent<PlayerController> ().activeHint == false  && player.GetComponent<PlayerController> ().activeTab == false) {
		...
		} else if (player.GetComponent<PlayerController> ().currentObjective == 11 && repairBar.GetComponent<Timer2> ().isDone == false  && player.GetComponent<PlayerController> ().activeHint == false  && player.GetComponent<PlayerController> ().activeTab == false) {
